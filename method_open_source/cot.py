...
Lets think step by step, finally you need to output the annotations in the form of "Intent=INTENT_NAME;Slot1=VALUE1;Slot2=VALUE2;..." in another line.
Here is the the sentence:

"""

iterative_prompt = """
Repeat the annotations in the form of "Intent=INTENT_NAME;Slot1=VALUE1;Slot2=VALUE2;..."
"""
...
with open(args.output_path, 'w', encoding='utf-8') as fout:
    ...
    for idx, sentence in enumerate(inputs_text):
        sentence['pred_slot_with_thought'] = outputs[idx]
    ...
    for idx, sentence in enumerate(tqdm(inputs_text)):
        history = [
            HumanMessage(content=prompt+sentence['text']),
            AIMessage(content=sentence['pred_slot_with_thought']),
